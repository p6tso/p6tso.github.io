...
### Большие файлы (>100MB):
- Всегда использует redirect на presigned URL
- Параметр `force_proxy=true` для принудительного проксирования

### Архивы и исполняемые файлы:
- Дополнительная проверка безопасности
- Возможен quarantine для подозрительных файлов
