...
**Технологии:** Python + Kafka Consumer + обработчики файлов
...
### Аутентификация:
- JWT токены для API (через API Gateway)
- Сервис-сервис аутентификация через mTLS

### Авторизация:
- RBAC роли: Student, Teacher, Admin
- Проверка прав доступа к файлам

### Защита данных:
- Шифрование файлов в MinIO (SSE)
